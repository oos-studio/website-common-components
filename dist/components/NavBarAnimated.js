...
class NavBarAnimated extends Component {
  constructor(props) {
    ...
    _defineProperty(this, "hideImageItem", () => {
      const {
        openImageItem
      } = this.state;
    ...
    _defineProperty(this, "clickDropdown", index => {
      const {
        hideDropdownMenu
      } = this;
  ...
  runAnimations() {
    ...
    if (showScrolledNav) {
      ...
      TweenLite.to('#navbar', duration, {
        ...
        TweenLite.to('#collapse', duration, { ...styles.scrolled.collapse
        }).then(() => {
          this.setState({
            activeNavImage: scrollNavImage,
            brandImageStyles: styles.brandImage.small
          });
          TweenLite.to('#navBrand', 0, {
            opacity: 0
          });
          TweenLite.to('#navBrand', 0, {
        ...
        TweenLite.to('#navbar', duration, { ...styles.scrolled.navbar,
          ease: Power2.easeOut
        });
        TweenLite.to('#divider', duration, {
          opacity: 1
        });
      });
    } else {
      ...
      TweenLite.to('#navBrand', duration, {
        ...
        tl.to('#collapse', { ...styles.collapse
        }, 0);
        tl.to('#navBrand', {
          transform: 'translateX(0px)',
          opacity: 1
        ...
        tl.to('#navBrand', {
          width: styles.brandImage.large.width
        }, 0);
        TweenLite.to('#navbar', duration, { ...styles.navbar,
          backdropFilter: 'none',
          ease: Power2.easeOut
        });
      });
    ...
    switch (item.type) {
      case 'link':
        ...
        React.createElement(Media, {
          object: true,
          src: item.image,
          style: activeNavIndex === index ? deepmerge(_imageStyles, _imageStyles.hover) : _imageStyles
        }) : item.text));
        break;
      ...
      case 'dropdown':
        ...
        React.createElement(Media, {
          ...
          object: true,
          src: item.image,
          style: activeNavIndex === index ? deepmerge(_imageStyles.lower, _imageStyles.hoverLower) : _imageStyles.lower
        }),
        /*#__PURE__*/
        React.createElement(Media, {
          onClick: () => hoverNavItem(item, index),
          object: true,
          src: item.image,
          style: activeNavIndex === index ? deepmerge(_imageStyles.upper, _imageStyles.hoverUpper) : _imageStyles.upper
  ...
  render() {
    ...
    return (
      ...
      React.createElement("div", {
        id: "imageItems",
        style: showScrolledNav ? deepmerge(_styles.imageItems, _styles.imageItems.scrolled) : _styles.imageItems
